    ...
    <div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
      ...
      {data.items.length === 0 && (
        <EmptyState
          ...
          description="Create a meeting, assign an AI secretary, and start the call. After it ends, your secretary will deliver a summary and be ready to answer questions."
        />
      )}
    </div>
  );
